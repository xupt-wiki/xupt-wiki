...
- 中国电信、中国联通办理校园号卡套餐（“校园卡”）后，可以开通有线宽带服务。
  ...
  - 宿舍进户网线接口在门侧面、<Tip text="这里的网口小概率不可用">2/5号床下</Tip>，如果同一宿舍内多人办理宽带，进户网口不够用的话，需要先接入<Tip text="需插电使用的网口分线器">交换机</Tip>分出多个网口后使用。
...
- WeNet<Tip text="一般情况下">一般情况下</Tip>不能直接通过 WiFi 桥接共享网络。
