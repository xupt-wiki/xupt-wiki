...
import type { LinkProps } from '../atomic/Link.vue'
...
<template>
<div class="link-list" :style="{ '--col-width': width }">
	<Link v-for="item, index in links" :key="index" card v-bind="item" :desc-lines />
</div>
</template>
